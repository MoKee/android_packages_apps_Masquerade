...
public class MasqDemo {
    ...
    public static void installDemo(Context context) {
        ArrayList<String> overlay_apks = new ArrayList<>();
    ...
    public static void uninstallDemo(Context context) {
        ArrayList<String> packages_to_remove = new ArrayList<>();
        // populate list however
        // disable overlays as needed
        Intent masqIntent = getMasqIntent(context);
    ...
    public static void restartSystemUIDemo(Context context) {
        Intent masqIntent = getMasqIntent(context);
    ...
    public static void fontsDemo(Context context) {
        Intent masqIntent = getMasqIntent(context);
